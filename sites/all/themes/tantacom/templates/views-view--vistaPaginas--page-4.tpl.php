...
<?php endif ?>
    <?php
        ...
        <? if ($nodo->field_foto[ 0 ][ filepath ] !=''){?>
           <? if ($nodo->field_partner_url[ 0 ][ value ] !=''){?>
            <a href="<?=$nodo->field_partner_url[ 0 ][ value ];?>" target="_blank">
           <? }?> 
       ...
       <? }?>  
             ...
             <p><strong><a href="<?=$nodo->field_partner_url[ 0 ][ value ];?>" target="_blank"><?php echo strip_tags ( $nodo->field_partner_url[ 0 ][ value ] ) ?></a> </strong></p>
             <p><strong><?php echo strip_tags ( $nodo->field_testimonio[ 0 ][ value ] ) ?> </strong></p>
             <?php echo '<p>' . $nodo->field_descripcion[ 0 ][ value ] . '</p>' ?>
             </article>
